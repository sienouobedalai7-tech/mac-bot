"""
MAC Bot (version GitHub Actions) - Envoi des messages Telegram

Adapté depuis la version originale : retrait de envoyer_message_avec_boutons,
repondre_callback et definir_commandes_menu, qui nécessitaient toutes un
webhook actif pour avoir un sens (répondre à un clic ou afficher un menu
"/" nécessite un serveur qui écoute Telegram en continu - voir le README).

Règles de formatage (conservées de l'original) :
